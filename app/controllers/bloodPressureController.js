...
const createBloodPressure = async (req, res) => {
    ...
    try {
        ...
        if (systolic || diastolic || date || time) {
            ...
            console.log("bloodPressureController:45", systolicValidation);
            const diastolicValidation = validateBloodPressure(diastolic);
            console.log("bloodPressureController:47", diastolicValidation);
            ...
            if (systolicValidation.isValid & diastolicValidation.isValid & dateValidation.isValid & timeValidation.isValid) {
                const user = req.session.username; 
